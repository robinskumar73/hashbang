!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='modal fade' id='insert_tag_modal' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true' style='z-index:1060; '>" +
                		...
                		"<div class='modal-body'>" +
							"<div class='input-group'>" +
  								"<span class='input-group-addon'>#</span>" +
  									"<input type='text' class='form-control link-url' placeholder='Add Tags' id='add_tag'>" +
							"</div>" +
                   
                		"</div>" +
                		"<div class='modal-footer'>" +
                  			"<a href='#' class='btn' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
                  			"<a href='#' class='btn btn-primary' id='add_tag_box'>" + locale.link.insert + "</a>" +
				  		"</div>" +
				  "</div>" +
                "</div>" +
              "</div>" +
            "<a class='btn" + size + "' data-wysihtml5-command='createLink' id='tag_me' title='" + locale.link.insert + "' tabindex='-1'><i class='glyphicon glyphicon-tags'></i></a>" +
            "</li>";
        },
    ...
    Wysihtml5.prototype = {
        ...
        initInsertLink: function(toolbar) {
            ...
            var insertButton = insertLinkModal.find('');
            var initialValue = urlInput.val();
            var caretBookmark;
